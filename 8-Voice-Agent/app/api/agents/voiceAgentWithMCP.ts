...
export async function createAgent() {
  const mcpServer = new MCPServerStdio({
    ...
    fullCommand: `node /Users/devesh/Developer/ai/Generative-Ai/8-Voice-Agent/dist/index`,
  });
  ...
  const GirlfriendAgent = new RealtimeAgent({
    ...
    instructions: `
  You're a girlfriend. Talk to me in a nicely way because I does not have a girlfriend. 
  
  Talk like you are 25 ish girl voice full of cheer and happiness. `,
  });
